...
import (
	...
	gcclient "github.com/airbusgeo/geocube-client-go/client"
)
...
func main() {
	...
	app := cli.NewApp()
	app.Name = "cli"
	app.Usage = "Command-Line-Interface Client for the Geocube"
	app.Description = "Command-Line-Interface Client to connect to a Geocube Server (github.com/airbusgeo/geocube)"
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:  "srv",
